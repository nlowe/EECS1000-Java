...
public class CCVerifyByLong
{
	 ...
	 * 		2A) If The digit is the first digit or an in an odd numbered position
	 * 			Double it. If it is greater than 9, sum the individual digits
	 * 	3) Add the digit to the running sum
	 * 	4) Iff the final sum ends in a zero, the number is valid.
	 * 
